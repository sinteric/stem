...
fn render_h1(out: &mut String, b: &Block, _t: &Theme) -> Result<(), std::fmt::Error> { render_heading(out, b, 1) }
fn render_h2(out: &mut String, b: &Block, _t: &Theme) -> Result<(), std::fmt::Error> { render_heading(out, b, 2) }
fn render_h3(out: &mut String, b: &Block, _t: &Theme) -> Result<(), std::fmt::Error> { render_heading(out, b, 3) }
fn render_h4(out: &mut String, b: &Block, _t: &Theme) -> Result<(), std::fmt::Error> { render_heading(out, b, 4) }
fn render_h5(out: &mut String, b: &Block, _t: &Theme) -> Result<(), std::fmt::Error> { render_heading(out, b, 5) }
fn render_h6(out: &mut String, b: &Block, _t: &Theme) -> Result<(), std::fmt::Error> { render_heading(out, b, 6) }
